...
![MLLM](https://img.shields.io/badge/MLLM-Multimodal%20LLMs-DB2777)
![Medical AI](https://img.shields.io/badge/Medical%20AI-Healthcare%20Intelligence-0F766E)

## Public Repositories

| Repository | Description |
| --- | --- |
| [hnu-digital-image-processing-project](https://github.com/1YeCheng/hnu-digital-image-processing-project) | Digital image processing coursework and experiments, including lung CT preprocessing, segmentation, morphology, Fourier filtering, geometric transformation, connected components, and Segment Anything mask export. |
| [Machine-Learning](https://github.com/1YeCheng/Machine-Learning) | Machine learning implementations and experiments, covering logistic regression, LDA, C4.5 decision trees, SVM/SVR, BP neural networks, validation methods, PR curves, confusion matrices, and WDBC breast cancer diagnosis. |
